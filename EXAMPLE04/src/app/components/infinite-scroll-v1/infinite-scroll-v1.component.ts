...
@Component({
  selector: 'app-infinite-scroll-v1',
  templateUrl: './infinite-scroll-v1.component.html',
  styleUrls: ['./infinite-scroll-v1.component.css']
})
export class InfiniteScrollV1Component implements OnInit {
